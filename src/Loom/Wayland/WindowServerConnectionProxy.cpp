...
{
    dbgln_if(WINDOW_SERVER_IPC_DEBUG, "WindowServer IPC: add_menu_item(menu_id={}, identifier={}, submenu_id={}, text={}, enabled={}, visible={}, checkable={}, checked={}, is_default={}, shortcut={}, exclusive={})", menu_id, identifier, submenu_id, text, enabled, visible, checkable, checked, is_default, shortcut, exclusive);
    (void)menu_id;
    (void)identifier;
    (void)submenu_id;
    (void)text;
...
{
    dbgln_if(WINDOW_SERVER_IPC_DEBUG, "WindowServer IPC: update_menu_item(menu_id={}, identifier={}, submenu_id={}, text={}, enabled={}, visible={}, checkable={}, checked={}, is_default={}, shortcut={})", menu_id, identifier, submenu_id, text, enabled, visible, checkable, checked, is_default, shortcut);
    (void)menu_id;
    (void)identifier;
    (void)submenu_id;
    (void)text;
...
{
    dbgln_if(WINDOW_SERVER_IPC_DEBUG, "WindowServer IPC: set_screen_layout(save={})", save);
    (void)screen_layout;
    (void)save;
    return nullptr;
}
...
{
    dbgln_if(WINDOW_SERVER_IPC_DEBUG, "WindowServer IPC: start_drag(text={})", text);
    (void)text;
    (void)mime_data;
    (void)drag_bitmap;
    return nullptr;
